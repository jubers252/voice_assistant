...
SAVE_DIR = os.path.join(os.path.dirname(__file__), "background_sound")  # Always save in model_training/background_sound
...
record_background_sound(SAVE_DIR, n_times=2000) 
